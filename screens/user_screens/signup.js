...
import { View, Alert, ScrollView, StyleSheet, KeyboardAvoidingView, Platform, Text } from 'react-native';
        ...
        <View style={styles.formContainer}>
          ...
          />
            ...
            <TouchableOpacity onPress={() => navigation.navigate('ClientLoginScreen')}>
              <Text style={{ color: '#1566C1', fontSize: 14, fontWeight: 'bold' }}>تسجيل الدخول</Text>
            </TouchableOpacity>
            <Text style={{ fontSize: 14, color: '#444' }}> قم بتسجيل دخول ؟</Text>
          </View>
          <View style={{ flex: 1 }} />
          <CustomButton 
            title="تابع" 
            ...
            type='filled'
            style={{ paddingTop: 40, marginBottom: 16 }}
          />
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
